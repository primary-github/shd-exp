...
> - Once in the literature note, use the annotations to create [[atomic idea]]. Link back in the idea note to this literature note. 
> - Check [[tag taxonomy]] to see if this could have any topic tags. Give preference to existing tags over creation of new ones.
